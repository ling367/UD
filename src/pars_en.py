...
# print(len(selection))
# #méthode 1
selection_100 = extract_corpus ('data/en_gum-ud-train.conllu')
def parsing_stanza ():
    doc = open('data/gum_en_extract.txt','w')
    for phrase in selection_100:
        doc.write(phrase)
    doc = open('data/gum_en_extract.txt')
    doc = doc.read()
...
depl_pars = open('data/gum_en_pars.conllu','w',encoding='utf-8')
start = 'id: 1	word:'
i = 0
